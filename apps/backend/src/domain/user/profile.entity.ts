...
import { UserName, UniversityId, IconUrl } from "./user.types";
...
export class Profile {
   ...
   * 新規作成
   */
  public static create(universityId: UniversityId, userName: string): Profile {
    this.validate(userName);
    return new Profile(userName as UserName, universityId);
  }
  ...
  public static fromPersistence(
    ...
    return new Profile(userName, universityId, iconUrl);
  }
